                    ...
                    return (
                        <div key={c.name} className="flex-1 flex flex-col items-center gap-3 group">
                            ...
                            <div className="flex flex-col items-center gap-1">
                                ...
                                <span className="text-[6px] text-white/20 uppercase font-black tracking-widest px-1 py-0.5 border border-white/5 bg-white/[0.02]">
                                    {c.name.slice(0, 3)}
                                </span>
                            </div>
                        </div>
