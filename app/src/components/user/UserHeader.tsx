...
interface UserHeaderProps {
    activeTab: 'physical' | 'profile' | 'region';
    onTabChange: (tab: 'physical' | 'profile' | 'region') => void;
}

export const UserHeader: React.FC<UserHeaderProps> = ({ activeTab, onTabChange }) => {
    return (
