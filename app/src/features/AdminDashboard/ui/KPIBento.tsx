...
export const KPIBento: React.FC = () => {
    ...
    return (
        <div className="h-full w-full flex gap-10 overflow-hidden px-2">
            ...
            {/* Right: Demographic Matrix */}
            <div className="flex-1 flex flex-col gap-6 border-l border-prism/30 pl-10 min-w-0 overflow-hidden relative">
                <DemographicMatrix />
            </div>
        </div>
    );
