    ...
    return (
        <div className="w-full h-full relative rounded-2xl overflow-hidden glass-panel">
            <Canvas camera={{ position: [0, 0, 12] }}>
                ...
                <ClusterNode
                    position={[-4, 2, 0]}
                    label={CLUSTER_TRANSLATIONS['Science'] || "Science"}
                ...
                <ClusterNode
                    position={[4, 2, 0]}
                    label={CLUSTER_TRANSLATIONS['Technology'] || "Technology"}
                ...
                <ClusterNode
                    position={[-4, -3, 0]}
                    label={CLUSTER_TRANSLATIONS['Economics'] || "Economics"}
                ...
                <ClusterNode
                    position={[4, -3, 0]}
                    label={CLUSTER_TRANSLATIONS['Art'] || "Art"}
